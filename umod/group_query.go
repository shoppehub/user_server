...
func (gq *GroupQuery) prepareQuery(ctx context.Context) error {
	for _, f := range gq.fields {
		if !group.ValidColumn(f) {
			return &ValidationError{Name: f, err: fmt.Errorf("umod: invalid field %q for query", f)}
		}
	}
	if gq.path != nil {
...
func (gq *GroupQuery) sqlAll(ctx context.Context) ([]*Group, error) {
	...
	_spec.Assign = func(columns []string, values []interface{}) error {
		if len(nodes) == 0 {
			return fmt.Errorf("umod: Assign called without calling ScanValues")
		}
...
func (gq *GroupQuery) sqlExist(ctx context.Context) (bool, error) {
	...
	if err != nil {
		return false, fmt.Errorf("umod: check existence: %w", err)
	}
	return n > 0, nil
}
...
func (ggb *GroupGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ggb.fields) > 1 {
		return nil, errors.New("umod: GroupGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ggb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ggb *GroupGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{group.Label}
	default:
		err = fmt.Errorf("umod: GroupGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ggb *GroupGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ggb.fields) > 1 {
		return nil, errors.New("umod: GroupGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ggb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ggb *GroupGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{group.Label}
	default:
		err = fmt.Errorf("umod: GroupGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ggb *GroupGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ggb.fields) > 1 {
		return nil, errors.New("umod: GroupGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ggb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ggb *GroupGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{group.Label}
	default:
		err = fmt.Errorf("umod: GroupGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ggb *GroupGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ggb.fields) > 1 {
		return nil, errors.New("umod: GroupGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ggb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ggb *GroupGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{group.Label}
	default:
		err = fmt.Errorf("umod: GroupGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (gs *GroupSelect) Strings(ctx context.Context) ([]string, error) {
	if len(gs.fields) > 1 {
		return nil, errors.New("umod: GroupSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := gs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (gs *GroupSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{group.Label}
	default:
		err = fmt.Errorf("umod: GroupSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (gs *GroupSelect) Ints(ctx context.Context) ([]int, error) {
	if len(gs.fields) > 1 {
		return nil, errors.New("umod: GroupSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := gs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (gs *GroupSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{group.Label}
	default:
		err = fmt.Errorf("umod: GroupSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (gs *GroupSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(gs.fields) > 1 {
		return nil, errors.New("umod: GroupSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := gs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (gs *GroupSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{group.Label}
	default:
		err = fmt.Errorf("umod: GroupSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (gs *GroupSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(gs.fields) > 1 {
		return nil, errors.New("umod: GroupSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := gs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (gs *GroupSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{group.Label}
	default:
		err = fmt.Errorf("umod: GroupSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
